...
Anyone is welcome to open link:https://github.com/jreleaser/jreleaser-opentelemetry-extension/issues[issues] and/or pull-requests for bugfixes,
feature-requests and/or ideas. If unsure where to start we encourage you to open a
link:https://github.com/jreleaser/jreleaser-opentelemetry-extension/discussions[discussion] topic first.
...
link:https://github.com/jreleaser/jreleaser-opentelemetry-extension/discussions[discussion] topic if you have questions.
...
1. `git clone https://github.com/jreleaser/jreleaser-opentelemetry-extension.git`
2. `cd jreleaser-opentelemetry-extension`
3. `./gradlew build`
 ...
 * Create an link:https://github.com/jreleaser/jreleaser-opentelemetry-extension/issues[issue]  outlining the fix or feature.
